...
![A collection of documents is split into text chunks and transformed into vector-based embeddings. Both text chunks and related embeddings are then stored in a vector store.](/assets/blog/ai-agents/rag-document-ingestion.png)
...
![Một tập hợp tài liệu được chia thành các text chunk và chuyển đổi thành embedding dựa trên vector. Cả text chunk và embedding liên quan sau đó được lưu trong vector store.](/assets/blog/ai-agents/rag-document-ingestion.png)
