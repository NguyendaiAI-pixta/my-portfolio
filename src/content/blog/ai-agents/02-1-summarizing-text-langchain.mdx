...
![Summarizing a document bigger than the LLM's context window](/assets/blog/ai-agents/summarization-mapreduce.png)
...
![Tóm tắt tài liệu lớn hơn context window của LLM](/assets/blog/ai-agents/summarization-mapreduce.png)
