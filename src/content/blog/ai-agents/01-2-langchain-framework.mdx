...
![LangChain architecture showing the flow from document loading through retrieval to LLM response](/assets/blog/ai-agents/langchain-architecture.png)
...
![Object model of classes associated with the Document core entity](/assets/blog/ai-agents/langchain-object-model-document.png)
...
![Object model of classes associated with LLMs](/assets/blog/ai-agents/langchain-object-model-llm.png)
...
![Kiến trúc LangChain thể hiện quy trình từ load tài liệu qua retrieval đến phản hồi của LLM](/assets/blog/ai-agents/langchain-architecture.png)
...
![Mô hình object của các class liên quan đến entity Document cốt lõi](/assets/blog/ai-agents/langchain-object-model-document.png)
...
![Mô hình object của các class liên quan đến LLM](/assets/blog/ai-agents/langchain-object-model-llm.png)
